/** CPRG03-10B.cpp
 *	
 *	Unit 3, Activity 10B Solution for CPRG 3202. In this activity, we will 
...
int main()
{
	...
	inputValue = GetValidInteger(MIN_INPUT, MAX_INPUT);
