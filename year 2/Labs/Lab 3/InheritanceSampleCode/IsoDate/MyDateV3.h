 ...
 *
 *  New in version 2014.03
 *	- Added long operator-(const MyDate&) // allows one date to be subtracted 
 *			from another
 *	- Changed private to protected (inheritance friendly)
 *  - Designated the following methods as virtual:
 *		setDate(int, int, int)
 *	    operator long()
 *		operator string()
 *   
